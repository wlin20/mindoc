...
func init() {
	...
	beego.Router("/register", &controllers.AccountController{}, "*:RegisterWithToken")
	beego.Router("/register_submit", &controllers.AccountController{}, "*:RegisterWithTokenSubmit")
