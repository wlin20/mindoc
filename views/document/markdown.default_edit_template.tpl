...
<div class="m-manual manual-editor">
    <div class="manual-head" id="editormd-tools" style="min-width: 1200px; position:absolute;">
        ...
        <div class="navbar-header pull-left manual-title" style="margin-right: 50px">
        ...
        <div class="editormd-group">
            ...
            <a href="javascript:;" data-toggle="tooltip" data-title="关闭实时预览"><i class="fa fa-eye-slash last" name="watch" unselectable="on"></i></a>
