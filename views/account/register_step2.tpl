...
<div class="container manual-body">
    <div class="row login">
        <div class="login-body">
            <form role="form" method="post" id="registerForm" action="{{urlfor "AccountController.RegisterWithTokenSubmit"}}">
                {{ .xsrfdata }}
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="email" class="form-control" placeholder="用户邮箱" name="email" value="{{.Email}}" id="email" autocomplete="off" readonly>
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
